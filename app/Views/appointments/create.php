...
<div class="header-group" style="margin-bottom: 24px;">
    <div>
        ...
        <p class="muted">Xếp lịch hẹn khám bệnh chi tiết cho bệnh nhân trong hệ thống.</p>
    </div>
</div>
...
<form method="post" action="/appointments" class="form-card" style="max-width: 600px;">
    <?= csrf_field() ?>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Ví dụ: Dentistry, Pediatrics, Cardiology..."
        >
